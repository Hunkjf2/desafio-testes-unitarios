...
describe("Get balance", () => {
  beforeAll(async () => {
    ...
    await connection.query(`
      ...
      VALUES
        ('11aa7822-7e41-4746-8edc-67e3da62bf05', 'Usuario 01', 'usuario01@gmail.com', '${password}', 'now()', 'now()')
    `);
    ...
    await connection.query(`
      INSERT INTO users
        (id, name, email, password, created_at, updated_at)
      VALUES
        ('22bb7822-7e41-4746-8edc-67e3da62bf05', 'Usuario 02', 'usuario02@gmail.com', '${password}', 'now()', 'now()')
    `);
  });
